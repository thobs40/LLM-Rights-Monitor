    ...
    <div className="flex h-screen bg-slate-900 overflow-hidden">
      ...
      <aside className="w-64 border-r border-slate-800 flex flex-col p-6 space-y-8">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-bold text-lg tracking-tight">RightsMonitor</h1>
        </div>
        ...
        <div className="p-4 bg-slate-800/50 rounded-xl border border-slate-700">
          ...
          <div className="flex justify-between items-end">
            <div>
              <p className="text-xl font-bold">$42.10</p>
            ...
            <>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-slate-800 p-6 rounded-2xl border border-slate-700 min-h-[400px] flex flex-col min-w-0">
                  <h3 className="text-lg font-semibold mb-6 flex items-center justify-between shrink-0">
          ...
          {activeTab === 'incidents' && (
            <div className="max-w-4xl mx-auto space-y-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold">Active Cases</h3>
                <div className="flex gap-2">
                  <span className="bg-red-500/10 text-red-500 px-3 py-1 rounded-full text-xs font-bold border border-red-500/20">1 Critical</span>
                  <span className="bg-yellow-500/10 text-yellow-500 px-3 py-1 rounded-full text-xs font-bold border border-yellow-500/20">2 High</span>
                </div>
              </div>
              {incidents.map(inc => (
